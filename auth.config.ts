...
// LA COOKIE DEL AMBIENTE DE PRUEBAS SE LLAMA DISTINTO. Hoy vive en otro host, así
// que no se pisarían; el día que comparta dominio con producción —o que alguien
// abra los dos en la misma pestaña— el token del otro ambiente no verifica contra
// este `AUTH_SECRET` y cada visita deslogearía a la otra. Cuesta una línea.
const EN_PRUEBAS = process.env.AMBIENTE === "pruebas";
...
export const authConfig = {
  ...
  cookies: {
    sessionToken: {
      ...
      options: { httpOnly: true, sameSite: "lax", path: "/", secure: !!process.env.VERCEL },
    },
  },
  callbacks: {
